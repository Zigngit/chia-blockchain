...
Write-Output "   ---"
Invoke-WebRequest -Uri "https://pypi.chia.net/simple/miniupnpc/miniupnpc-2.1-cp38-cp38-win_amd64.whl" -OutFile "miniupnpc-2.1-cp38-cp38-win_amd64.whl"
...
Copy-Item "..\venv\Lib\site-packages\pywin32_system32\*" -Destination "dist\daemon\" -Recurse
